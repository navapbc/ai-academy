...
| W4 | Missing features | **W4-1 DONE — PR #57 (P4.7) merged** ✓ (PM-validated on the merged state; branch FF'd to main for fresh CI); W4-2 failure log 2.9 (P4.9, M); **W4-3 portfolio/Diligence 2.11 (P4.8, L) ← next**; W4-4 GLAT gate 2.14 (P4.10, L, needs W3-1); W4-5 champion review queue (needs W2-2, L); W4-6 Phase 5 portal (P5.1→5.6) | P1–P2 | S→L | W4-1 done; W4-3 (P4.8) next |
