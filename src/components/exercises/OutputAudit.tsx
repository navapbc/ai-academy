...
import { ShieldCheck, Check, X, Sparkles, ScanSearch } from 'lucide-react';
...
export default function OutputAudit({ config, labId }: Props) {
  ...
  return (
    <div className="bg-white border-2 border-nava-mint rounded-3xl p-8 shadow-sm space-y-8" id="output-audit">
